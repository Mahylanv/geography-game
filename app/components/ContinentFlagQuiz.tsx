...
export default function ContinentFlagQuiz({ continent }: { continent: string }) {
  ...
  return (
    <div className="page-shell flex flex-col items-center justify-center text-center">
      <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-slate-900">Quel est ce pays ? ({continent})</h2>
      ...
      {current?.flag && (
        <div className="card-frame mb-4">
          <img src={current.flag} alt="Drapeau" className="w-72 sm:w-80 mx-auto rounded-xl" />
